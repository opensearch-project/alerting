...
class IndexMonitorV2ResponseTests : OpenSearchTestCase() {
    fun `test index monitor v2 response as stream`() {
        val req = IndexMonitorV2Response(
            id = "abc",
            version = 2L,
            seqNo = 1L,
            primaryTerm = 1L,
        ...
        val newReq = IndexMonitorV2Response(sin)
