...
val ALERTING_SEARCH_INDEX_EMAIL_GROUP_ACCESS = "alerting_index_email_group_access"
...
val ROLE_TO_PERMISSION_MAPPING = mapOf(
    ...
    ALERTING_SEARCH_INDEX_EMAIL_GROUP_ACCESS to "cluster:admin/opendistro/alerting/destination/email_group/write",
