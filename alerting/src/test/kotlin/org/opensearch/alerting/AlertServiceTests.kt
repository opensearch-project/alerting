...
class AlertServiceTests : OpenSearchTestCase() {
    ...
    fun setup() {
        ...
        settingSet.add(AlertingSettings.ALERT_FINDING_ENABLED)
        settingSet.add(AlertingSettings.ALERT_FINDING_MAX_DOCS)
        settingSet.add(AlertingSettings.ALERT_FINDING_INDEX_MAX_AGE)
        settingSet.add(AlertingSettings.ALERT_FINDING_ROLLOVER_PERIOD)
