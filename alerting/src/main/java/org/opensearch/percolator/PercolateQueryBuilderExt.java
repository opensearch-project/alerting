...
public class PercolateQueryBuilderExt extends AbstractQueryBuilder<PercolateQueryBuilderExt> {
     ...
     */
    public PercolateQueryBuilderExt(
            String field,
    ...
    private static final ConstructingObjectParser<PercolateQueryBuilderExt, Void> PARSER = new ConstructingObjectParser<>(NAME, args -> {
        ...
        if (indexedDocId != null) {
            ...
            return new PercolateQueryBuilderExt(field, Collections.singletonList(document), XContentType.JSON);
        } else {
            return new PercolateQueryBuilderExt(field, documents, XContentType.JSON);
        }
    });
    static {
        ...
        PARSER.declareString(PercolateQueryBuilderExt::queryName, AbstractQueryBuilder.NAME_FIELD);
        PARSER.declareFloat(PercolateQueryBuilderExt::boost, BOOST_FIELD);
    ...
    protected QueryBuilder doRewrite(QueryRewriteContext queryShardContext) {
        ...
        PercolateQueryBuilderExt rewritten = new PercolateQueryBuilderExt(field, documentSupplier::get);
        if (name != null) {
            rewritten.setName(name);
        }
        return rewritten;
