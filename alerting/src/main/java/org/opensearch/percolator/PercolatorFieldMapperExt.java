...
public class PercolatorFieldMapperExt extends ParametrizedFieldMapper {
    ...
    static final String CONTENT_TYPE = "percolator_ext";
    ...
    static class Builder extends ParametrizedFieldMapper.Builder {
        ...
        @Override
        public PercolatorFieldMapperExt build(BuilderContext context) {
            ...
            context.path().remove();
            return new PercolatorFieldMapperExt(
                    name(),
                    fieldType,
