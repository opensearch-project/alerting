...
class AlertingSettings {
    companion object {
         ...
         */
        val PERCOLATE_QUERY_DOCS_SIZE_MEMORY_PERCENTAGE_LIMIT =
            Setting.intSetting(
         ...
         */
        val DOC_LEVEL_MONITOR_SHARD_FETCH_SIZE =
            Setting.intSetting(
         ...
         */
        val DOC_LEVEL_MONITOR_FANOUT_MAX_DURATION =
         ...
         */
        val DOC_LEVEL_MONITOR_EXECUTION_MAX_DURATION =
            Setting.positiveTimeSetting(
         ...
         * execution
         */
        val PERCOLATE_QUERY_MAX_NUM_DOCS_IN_MEMORY =
            Setting.intSetting(
         ...
         */
        val DOC_LEVEL_MONITOR_FETCH_ONLY_QUERY_FIELDS_ENABLED =
            Setting.boolSetting(
        ...
        val MOVE_ALERTS_BACKOFF_MILLIS =
            Setting.positiveTimeSetting(
        ...
        val ALERT_HISTORY_ROLLOVER_PERIOD =
            Setting.positiveTimeSetting(
        ...
        val FINDING_HISTORY_ROLLOVER_PERIOD =
            Setting.positiveTimeSetting(
        ...
        val ALERT_HISTORY_INDEX_MAX_AGE =
            Setting.positiveTimeSetting(
        ...
        val FINDING_HISTORY_INDEX_MAX_AGE =
            Setting.positiveTimeSetting(
        ...
        val ALERT_HISTORY_RETENTION_PERIOD =
            Setting.positiveTimeSetting(
        ...
        val FINDING_HISTORY_RETENTION_PERIOD =
            Setting.positiveTimeSetting(
        ...
        val MAX_ACTIONABLE_ALERT_COUNT =
            Setting.longSetting(
        ...
        val CROSS_CLUSTER_MONITORING_ENABLED =
            Setting.boolSetting(
        ...
        val FINDINGS_INDEXING_BATCH_SIZE =
            Setting.intSetting(
        ...
        val DOC_LEVEL_MONITOR_FAN_OUT_NODES =
            Setting.intSetting(
        ...
        val COMMENTS_HISTORY_INDEX_MAX_AGE =
            Setting.positiveTimeSetting(
        ...
        val COMMENTS_HISTORY_ROLLOVER_PERIOD =
            Setting.positiveTimeSetting(
        ...
        val COMMENTS_HISTORY_RETENTION_PERIOD =
            Setting.positiveTimeSetting(
        ...
        val MAX_COMMENTS_PER_NOTIFICATION =
            Setting.intSetting(
        ...
        val ALERT_V2_HISTORY_ROLLOVER_PERIOD =
            Setting.positiveTimeSetting(
        ...
        val ALERT_V2_HISTORY_INDEX_MAX_AGE =
            Setting.positiveTimeSetting(
        ...
        val ALERT_V2_HISTORY_RETENTION_PERIOD =
            Setting.positiveTimeSetting(
        ...
        val ALERT_V2_MONITOR_EXECUTION_MAX_DURATION =
            Setting.positiveTimeSetting(
        ...
        val ALERTING_V2_MAX_THROTTLE_DURATION =
            Setting.longSetting(
        ...
        val ALERTING_V2_MAX_EXPIRE_DURATION =
            Setting.longSetting(
        ...
        val ALERTING_V2_MAX_LOOK_BACK_WINDOW =
            Setting.longSetting(
        ...
        val ALERTING_V2_MAX_QUERY_LENGTH =
            Setting.longSetting(
        ...
        val ALERTING_V2_QUERY_RESULTS_MAX_DATAROWS =
            Setting.longSetting(
        ...
        val ALERT_V2_QUERY_RESULTS_MAX_SIZE =
            Setting.longSetting(
        ...
        val ALERT_V2_PER_RESULT_TRIGGER_MAX_ALERTS =
            Setting.intSetting(
        ...
        val NOTIFICATION_SUBJECT_SOURCE_MAX_LENGTH =
            Setting.intSetting(
        ...
        val NOTIFICATION_MESSAGE_SOURCE_MAX_LENGTH =
            Setting.intSetting(
