...
class LegacyOpenDistroDestinationSettings {
    companion object {
        ...
        val EMAIL_USERNAME: Setting.AffixSetting<SecureString> =
        ...
        val EMAIL_PASSWORD: Setting.AffixSetting<SecureString> =
            Setting.affixKeySetting(
                EMAIL_DESTINATION_SETTING_PREFIX,
                "password",
                // Needed to coerce lambda to Function type for some reason to avoid argument mismatch compile error
        ...
        private fun getLegacySecureDestinationSettings(
            settings: Settings,
