...
interface MonitorV2 : ScheduledJob {
    ...
    enum class MonitorV2Type(
        ...
        companion object {
            fun enumFromString(value: String): MonitorV2Type? = MonitorV2Type.entries.find { it.value == value }
        }
    }
    ...
    companion object {
        ...
        fun parse(
            ...
            val monitorType =
                MonitorV2Type.enumFromString(monitorTypeText)
        ...
        fun readFrom(sin: StreamInput): MonitorV2 =
            when (val monitorType = sin.readEnum(MonitorV2Type::class.java)) {
