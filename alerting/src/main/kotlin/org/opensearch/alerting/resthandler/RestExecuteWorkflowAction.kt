    ...
    override fun replacedRoutes(): MutableList<RestHandler.ReplacedRoute> {
        return mutableListOf(
            RestHandler.ReplacedRoute(
                ...
                RestRequest.Method.POST,
                "${AlertingPlugin.LEGACY_OPENDISTRO_WORKFLOW_BASE_URI}/{workflowID}/_execute"
            ),
            RestHandler.ReplacedRoute(
                RestRequest.Method.POST,
                "${AlertingPlugin.WORKFLOW_BASE_URI}/_execute",
                RestRequest.Method.POST,
                "${AlertingPlugin.LEGACY_OPENDISTRO_WORKFLOW_BASE_URI}/_execute"
            )
        )
    }
