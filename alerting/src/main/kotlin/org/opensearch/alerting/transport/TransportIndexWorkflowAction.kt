...
class TransportIndexWorkflowAction
    ...
    constructor(
                ...
                try {
                    ...
                    for (monitor in monitors) {
                        ...
                        if (
                            ...
                            monitorMetadata =
                                monitorMetadata.copy(sourceToQueryIndexMapping = oldMonitorMetadata!!.sourceToQueryIndexMapping)
                        }
                ...
                try {
                    ...
                    for (monitor in monitors) {
                        ...
                        if (!created &&
                            ...
                            val oldMonitorMetadata = MonitorMetadataService.getMetadata(monitor)
                            updatedMetadata =
                                updatedMetadata.copy(sourceToQueryIndexMapping = oldMonitorMetadata!!.sourceToQueryIndexMapping)
        ...
        private fun validateChainedMonitorFindingsMonitors(
            ...
            delegates.forEach {
                val delegateMonitor =
                    monitorsById[it.monitorId] ?: throw AlertingException.wrap(
