...
class TransportGetWorkflowAlertsAction
    ...
    constructor(
        ...
        override fun doExecute(
            ...
            val getWorkflowAlertsRequest =
                request as? GetWorkflowAlertsRequest
            ...
            val from =
                if (getWorkflowAlertsRequest.alertIds.isNullOrEmpty()) {
        ...
        fun resolveAssociatedAlertsIndexName(getAlertsRequest: GetWorkflowAlertsRequest): String =
            if (getAlertsRequest.alertIndex.isNullOrEmpty()) {
                ...
                getAlertsRequest.associatedAlertsIndex!!
            }
        ...
        private fun parseAlertsFromSearchResponse(response: SearchResponse) =
