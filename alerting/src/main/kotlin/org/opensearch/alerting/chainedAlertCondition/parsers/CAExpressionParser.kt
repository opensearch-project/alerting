...
import org.opensearch.alerting.chainedAlertCondition.resolvers.CARPNResolver
...
) : CAExpressionRPNBaseParser(triggerExpression) {

    override fun parse(): CARPNResolver {
        ...
        return CARPNResolver(convertInfixToPostfix(breaks))
    }
