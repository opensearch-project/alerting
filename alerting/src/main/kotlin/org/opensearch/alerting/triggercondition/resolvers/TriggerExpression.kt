...
sealed class TriggerExpression {
    ...
    private fun resolveAnd(
        documentSet1: Set<String>,
        documentSet2: Set<String>,
    ): Set<String> = documentSet1.intersect(documentSet2)

    private fun resolveOr(
        documentSet1: Set<String>,
        documentSet2: Set<String>,
    ): Set<String> = documentSet1.union(documentSet2)

    private fun resolveNot(
        allDocs: Set<String>,
        documentSet2: Set<String>,
    ): Set<String> = allDocs.subtract(documentSet2)

    // Operators implemented as operator functions
    class And(
        val docSet1: Set<String>,
        val docSet2: Set<String>,
    ) : TriggerExpression()
